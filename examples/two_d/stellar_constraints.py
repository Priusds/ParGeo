...
def debug_constraint(): 
    ...
    c1 = shapely.Polygon(Circle(midpoint=(0.4, 0.5), radius=0.1).discretize_hole(refs=50))
    c2 = shapely.Polygon(Circle(midpoint=(0.5, 0.5), radius=0.1).discretize_hole(refs=50))
